                ...
                <el-col :span="12">
                    ...
                    class="flight-info-center">
                        ...
                        <el-col :span="8" class="flight-airport">
                            ...
                            <span>{{data.dsr_airport_name}}{{data.dst_airport_quay}}</span>
                        </el-col>
                    </el-row>
                </el-col>
...
export default {
    ...
    props: {
        // data表示组件可以接收的属性
        data: {
            // type是不能修改的,用于声明属性的类型
            type: Object,
            // 调用组件不传值,采用default的默认值
            default: {}
        }
    },
    computed: { 
